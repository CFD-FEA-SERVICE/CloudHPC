...
wget "https://github.com/firemodels/test_bundles/releases/download/FDS_TEST/FDS-6.10.1-334_SMV-6.10.1-199_test_win.exe" -OutFile "FDS-6.10.1-334_SMV-6.10.1-199_test_win.exe"
$wsh.Popup("Complete FDS installation process ...")
#Start-Process .\FDS-6.10.1_SMV-6.10.1_win.exe -NoNewWindow -Wait
Start-Process .\FDS-6.10.1-334_SMV-6.10.1-199_test_win.exe -NoNewWindow -Wait
...
wget "https://download.blender.org/release/Blender4.1/blender-4.1.1-windows-x64.msi" -OutFile "blender-4.1.1-windows-x64.msi"
$wsh.Popup("Complete blender installation process ...")
#Start-Process .\blender-4.4.3-windows-x64.msi -NoNewWindow -Wait
Start-Process .\blender-4.1.1-windows-x64.msi -NoNewWindow -Wait
