...
[TEMPLATES AND EXAMPLES]()
   ...
   * [Solver input templates](https://github.com/CFD-FEA-SERVICE/CloudHPC/tree/master/template)
   * [Ready-to-run example cases](https://github.com/CFD-FEA-SERVICE/CloudHPC/tree/master/exampleCloudHPC)

[TOOLS]()

   * [cloudHPC dedicated tools](https://github.com/CFD-FEA-SERVICE/CloudHPC/releases)
   * [PYROSIM - Run an analysis](https://cloudhpc.cloud/2022/05/07/execute-analysis-using-pyrosim-on-cloudhpc/)
